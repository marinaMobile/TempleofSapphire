...
import com.kitkagames.black.CNST.C1
import com.kitkagames.black.CNST.D1
import com.kitkagames.black.CNST.DEV
import com.kitkagames.white.White
        ...
        runBlocking {
            try {
                ...
                if (jsoup == CNST.jsoupCheck) {
                    Intent(applicationContext, White::class.java).also { startActivity(it) }
                } else {
